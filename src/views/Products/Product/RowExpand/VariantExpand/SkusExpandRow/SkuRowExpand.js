...
class SkuRowExpand extends Component {
    constructor(props) {
        super(props);
        this.state = {
            manufacturers: {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        skus.sku_expand_data = nextProps.data.sku_expand_data;
        skus.s_table_data = [skus.sku_expand_data];
        this.setState({ skus });
    ...
    componentWillMount() {
        ...
        if (this.props.data != null) {
            // console.log(this.props.data);
            var skus = { ...this.state.skus };
            skus.sku_expand_data = this.props.data.sku_expand_data;
            skus.s_table_data = [skus.sku_expand_data];
            this.setState({ skus });
        ...
        if (this.props.data != null) {
            ...
            return (
                <div style={{ 'margin-left': '45px' }}>
                    <BootstrapTable width='190' data={this.state.skus.s_table_data} condensed
                    ...
                    >
                        ...
                        <TableHeaderColumn dataAlign='center' dataField='id' expandable={false} isKey={true} expandable={false} dataFormat={this.tableInputIdField} >id
                    </TableHeaderColumn>

                        <TableHeaderColumn dataAlign='center' dataField='name' expandable={false} dataFormat={this.tableInputNameField} > Name
                        </TableHeaderColumn>

                        <TableHeaderColumn dataAlign='center' dataField='manufacturer_name' expandable={false} dataFormat={this.tableInputManuField}>Manufacturer </TableHeaderColumn>
                        <TableHeaderColumn dataAlign='center' dataField='uom_name' expandable={false} dataFormat={this.tableInputUomField}>Uoms</TableHeaderColumn>
