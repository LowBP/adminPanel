...
class ManuFactureRowExpand extends Component {
    constructor(props) {
        super(props);
        this.state = {
            manufacturers: {
    ...
    componentWillReceiveProps(nextProps) {
        console.log("nextpr", nextProps.data.manufacture_expand_data)
        if (nextProps.data.manufacture_expand_data != null) {
            var manufacturers = { ...this.state.manufacturers };
            manufacturers.manufacture_expand_data = nextProps.data.manufacture_expand_data;
    ...
    componentWillMount() {
        ...
        if (this.props.data != null) {
            ...
            var manufacturers = { ...this.state.manufacturers };
            manufacturers.manufacture_expand_data = this.props.data.manufacture_expand_data;
            manufacturers.m_table_data = [manufacturers.manufacture_expand_data];
            this.setState({ manufacturers });
            ...
            return (
                <div style={{ 'margin-left': '45px' }}>
                    ...
                    >
                        ...
                        <TableHeaderColumn dataAlign='center' dataField='name' expandable={false} isKey={true} expandable={false} dataFormat={this.tableInputIdField} >id
                    </TableHeaderColumn>

                        <TableHeaderColumn dataAlign='center' dataField='id' expandable={false} dataFormat={this.tableInputNameField} >Manufacturers Name
                        </TableHeaderColumn>

                        <TableHeaderColumn dataAlign='center' dataField='city' expandable={false} dataFormat={this.tableInputCityField}>City </TableHeaderColumn>
                        <TableHeaderColumn dataAlign='center' dataField='state' expandable={false} dataFormat={this.tableInputCityField}>State </TableHeaderColumn>
                        <TableHeaderColumn dataAlign='center' dataField='address' expandable={false} dataFormat={this.tableInputCityField}>Address   </TableHeaderColumn>
                        <TableHeaderColumn dataAlign='center' dataField='streetAddress' expandable={false} dataFormat={this.tableInputCityField}>Street Address   </TableHeaderColumn>
                        <TableHeaderColumn dataAlign='center' width="300" tdStyle={{ whiteSpace: 'normal' }} dataField='tags' expandable={false} dataFormat={this.tableInputCityField} > Tags                    </TableHeaderColumn>
...
export default ManuFactureRowExpand;